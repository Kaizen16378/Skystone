...
public class ConceptTensorFlowObjectDetectionWorkon {
    /**
     ...
     * is explained below.
     */
    @TeleOp(name = "Concept: TensorFlow Object Detection NEW", group = "Concept")
    //@Disabled
    public class ConceptTensorFlowObjectDetectionNEW extends LinearOpMode {
